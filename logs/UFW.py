...
while True:
    ...
    log = date + " "+ip_names[ip]+" " + "kernel: [ " + str(timeUp) + "] [UFW " + flag + "] " + inout + " MAC=" + MAC + " " + srcdst + " LEN=" + str(random.randint(10,5000)) + " TOS=0x00 PREC=0x00 TTL=" + str(random.randint(20,100)) + " ID=" + str(random.randint(10000, 99999)) + " DF PROTO=" + random.choice(PROTO) + " SPT=" + str(random.randint(10,10000))+ " DPT=" + str(random.randint(10,10000)) + " LEN=" + str(random.randint(3,300))
    
    #Escrivim la linia al log y esperem entre 2 y 5 segons per no crear massa linies de log
